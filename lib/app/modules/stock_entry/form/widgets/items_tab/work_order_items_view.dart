...
/// Items list rendered when [StockEntrySource.workOrder] is active.
/// Each row is pre-filled from the ERPNext BOM explosion and is tappable
/// to open [UniversalItemFormSheet] for qty / batch / rack confirmation.
class WorkOrderItemsView extends StatelessWidget {
  final StockEntryFormController controller;
  final StockEntry entry;

  const WorkOrderItemsView({
    super.key,
